...
// (Slowest speed + Reaction; Hold / Ease-back stay options-only). They're not
// per-site: each writes its global key live (the content sampler picks it up via
// storage.onChanged). Mirrors options/sections/AutoSlow.tsx.
...
export function useAutoSlowKnobs(): AutoSlowKnobs {
  ...
  useStored(["autoSlowFloor", "autoSlowReaction"], (r) => {
